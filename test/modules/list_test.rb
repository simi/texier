...
class Texier::Modules::ListTest < Test::Unit::TestCase
  ...
  def test_unordered_list_styles
    assert_equal_output '<ul><li>one</li><li>two</li></ul>', "- one\n- two"
    assert_equal_output '<ul><li>one</li><li>two</li></ul>', "-one\n-two"
    assert_equal_output '<ul><li>one</li><li>two</li></ul>', "+ one\n+ two"
    assert_equal_output '<ul><li>one</li><li>two</li></ul>', "* one\n* two"
  end
  ...
  def test_ordered_list_styles
    assert_equal_output '<ol><li>one</li><li>two</li></ol>', "1. one\n2. two"
    assert_equal_output '<ol><li>one</li><li>two</li></ol>', "1) one\n2) two"
    assert_equal_output(
  ...
  def test_ordered_list_with_arabic_numeral_with_dot_style_should_start_with_number_one
    assert_equal_output '<ol><li>one</li><li>two</li></ol>', "1. one\n2. two"
    assert_equal_output "<p>2. one\n3. two</p>", "2. one\n3. two"
  end

  def test_list_item_styles_in_one_list_should_not_be_mixed
    assert_equal_output '<ul><li>one</li></ul><ul><li>two</li></ul>', "- one\n+ two"
  end
