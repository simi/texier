...
class Texier::Modules::ModifierTest < Test::Unit::TestCase
  ...
  def test_title
    assert_equal_output '<p><em title="foo">hello</em></p>', '*hello .(foo)*'
    assert_equal_output '<p><em title="foo">hello</em></p>', '*hello .( foo  )*'
  end
  
  def test_class
    assert_equal_output '<p><em class="foo">hello</em></p>', '*hello .[foo]*'
  end

  def test_many_classes
    assert_equal_output '<p><em class="foo bar">hello</em></p>', '*hello .[foo bar]*'
    assert_equal_output '<p><em class="foo bar">hello</em></p>', '*hello .[foo   bar]*'
  end
  ...
  def test_only_allowed_classes_should_be_used
    ...
    assert_equal_output '<p><em class="foo">hello</em></p>', '*hello .[foo]*'
    assert_equal_output '<p><em>hello</em></p>', '*hello .[bar]*'
    assert_equal_output '<p><em class="foo">hello</em></p>', '*hello .[foo bar]*'
  end

  def test_id
    assert_equal_output '<p><em id="foo">hello</em></p>', '*hello .[#foo]*'
  end
  ...
  def test_onle_allowed_styles_should_be_used
    ...
    assert_equal_output '<p><em>hello</em></p>', '*hello .{color: red}*'
    assert_equal_output(
      '<p><em style="font-size: 20px">hello</em></p>', 
  ...
  def test_only_allowed_attributes_should_be_used
    ...
    assert_equal_output '<p><em>hello</em></p>', '*hello .{onmouseover: hello()}*'
  end
  ...
  def test_disallow_modifier
    ...
    assert_equal_output '<p><em>hello .[foo]</em></p>', '*hello .[foo]*'
  end
end
